...
//---------------dev tools --------------------
import DevTools from './share/devtools/devtool';
...
import increment from './share/redux/actions/increment';
// const increment =  () => ({ type: 'increment' })

import testpromise  from './share/redux/actions/testpromise';
...
import testact  from './share/redux/actions/testact';
  // const testact =  (owner) => {
  ...
  //work
import serverapi  from './share/redux/actions/serverapi';
...
import decrement  from './share/redux/actions/decrement';
  // const decrement =  () => ( { type: 'decrement' } )
import addtodo  from './share/redux/actions/addtodo';
  // const addtodo =    () => ({ type: 'addtodo',  text: 'addtodo'  })
import edittodo  from './share/redux/actions/edittodo';
  // const edittodo =   () => ({ type: 'edittodo', text: 'edittodo' })
import create  from './share/redux/actions/create';
  // const create = () => ({ type: 'create', text: 'create' })
import read  from './share/redux/actions/read';
  // const read = () => ({ type: 'read', text: 'read' ,id:1 })
import update  from './share/redux/actions/update';
  // const update = () => ({ type: 'update', text: 'update' , id:2 })
import deletex  from './share/redux/actions/deletex';
...
import actions  from './share/redux/actions'; // sumaction
// const actions = {
//   increment: increment,
//   decrement: decrement,
//   addtodo: addtodo,
...
//reducer-----------------------------------------
import employee  from './share/redux/reducers/employee';
...
import counter  from './share/redux/reducers/counter';
...
import testdata  from './share/redux/reducers/testdata';    
...
import todos  from './share/redux/reducers/todos';
...
//-----------------middleware----------------------------
import mymiddware  from './share/redux/middlewares/mymiddleware';
...
import mapcounter from './share/redux/mapstate/mapcounter'
import mapState  from './share/redux/mapstate/mapstate';
...
import mapDispatch  from './share/redux/mapdespatch/mapdispatch';
...
import Dispcount  from './share/components/dispcount';
// @connect( 
//     // mapcounter,
